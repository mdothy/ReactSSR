...
let CommitSuggest = (props)=>{
    ...
    return (
        <div className="commitSuggest">
        <table className="commitSuggest-tbl">
            <caption>需求反馈表</caption>
            <tbody>
                <tr>
                    <td className="commitSuggest-title">需求反馈人</td>
                    <td>
                        <TreeSelect
                            style={{ width: "100%" }}
                    ...
                    <td className="commitSuggest-title">所属部门</td>
                    <td>
                        <TreeSelect
                            style={{ width: 300 }}
                            dropdownStyle={{ maxHeight: 400, overflow: 'auto' }}
                    ...
                    <td className="commitSuggest-title">提交时间</td>
                    <td>{new Date().toLocaleString()}</td>
                </tr>
                <tr>
                    <td className="commitSuggest-title">所属模块</td>
                    <td>
                    ...
                    <td className="commitSuggest-title">流程名称</td>
                    <td colSpan="3">
                ...
                <tr>
                    <td className="commitSuggest-title">需求描述</td>
                    <td colSpan="5">
                        <Input.TextArea rows={4} placeholder="请填写简要的描述信息" />
                    </td>
                </tr>
                <tr>
                    <td className="commitSuggest-title">附件</td>
                    <td colSpan="5">
                        <Upload {...uploadConfig}>
                            <Button>
